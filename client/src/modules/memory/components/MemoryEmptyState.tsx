  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onAction}
        className="focus-ring mt-8 inline-flex items-center gap-2 rounded-full bg-white/[0.06] px-5 py-2.5 text-sm font-medium text-white/70 ring-1 ring-white/[0.08] transition-colors hover:bg-white/[0.1] hover:text-white"
