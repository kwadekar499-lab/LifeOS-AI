    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="focus-ring inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-[#0A0A0F] transition-shadow hover:shadow-[0_0_24px_rgba(255,255,255,0.1)] disabled:cursor-not-allowed disabled:opacity-50 sm:shrink-0"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          ...
          <span className="hidden sm:inline">{KNOWLEDGE_COPY.filterLabel}</span>
        </button>
        ...
        >
          ...
          <span className="hidden sm:inline">{KNOWLEDGE_COPY.sortLabel}</span>
        </button>
