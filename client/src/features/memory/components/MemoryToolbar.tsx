    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="Coming Soon"
          onClick={onNewMemory}
          className="focus-ring inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-[#0A0A0F] transition-shadow hover:shadow-[0_0_24px_rgba(255,255,255,0.1)] disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none"
